...
table-striped table-hover dataTable">
							<tbody>
								...
								<c:forEach var="api" items="${list}" varStatus="xh">
									<tr>
										<td><c:out value="${xh.count}" /></td>
										<td><c:out value="${api.aId}" /></td>
										<td><c:out value="${api.aName}" /></td>
										<td><c:out value="${api.aUrl}" /></td>
										<td><c:out value="${api.aType}" /></td>
										<td><c:out value="${api.aParam}" /></td>
										<td><c:out value="${api.aDescription}" /></td>
										<td><a href="delete.do?id=${api.aId}"><i
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">新增接口数据</h4>
				</div>
				<div class="modal-body">
					<form class="form-horizontal" id="addForm" method="post"
						...
						<div class="box-body">
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-2 control-label">接口名称</label>
								<div class="col-sm-8">
							...
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-2 control-label">接口URL</label>
								<div class="col-sm-8">
									<input type="text" name="aUrl" class="form-control input-sm"
										check-type="required">
								</div>
								<div class="col-sm-2"></div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" name="aType" class="form-control input-sm"
										check-type="required">
								</div>
								<div class="col-sm-2"></div>
							</div>
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-2 control-label">接口参数</label>
								<div class="col-sm-8">
									<input type="text" name="aParam" class="form-control input-sm"
										check-type="required">
								</div>
								<div class="col-sm-2"></div>
							</div>
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-2 control-label">接口描述</label>
								<div class="col-sm-8">

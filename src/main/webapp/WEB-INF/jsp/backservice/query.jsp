...
table-striped table-hover dataTable">
							<tbody>
								...
								<c:if test="${list!=null}">
									<c:forEach var="bc" items="${list}" varStatus="xh">
										<tr>
											<td><c:out value="${xh.count}" /></td>
											<td><c:out value="${bc.bcOutId}" /></td>
											<td><c:out value="${bc.bcFault}" /></td>
											<td><c:out value="${bc.bcResolvent}" /></td>
											<td><c:out value="${bc.bcNetwork}" /></td>
											<td><c:out value="${bc.bcResolveId}" /></td>
											<td><fmt:formatDate value="${bc.bcResolveTime}"

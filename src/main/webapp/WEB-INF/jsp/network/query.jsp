								...
								<div class="box-body">
									<table  style="width: 75%">
										<tr>
											...
											<td><input type="text" value="${network.nCode}" name="nCode" class="form-control input-sm"></td>
											<td align="center">区域负责人:</td>
											<td><input type="text" value="${network.nLeader }" name="nLeader"  class="form-control input-sm"></td>
											<td align="center">负责人电话:</td>
											<td><input type="text" value="${network.nLeaderTelphone }" name="nLeaderTelphone" class="form-control input-sm"></td>
										</tr>
									</table>
								</div>
								<div class="col-sm-12">
									...
									<button type="button" onclick="addDialog()"
										class="btn btn-default btn-sm">新增区域</button>
								</div>
							</form>
						</div>
					</div>
...
table-striped table-hover dataTable">
							<tbody>
								...
								<c:if test="${list== null || fn:length(list) == 0}">
									<tr>
										<td colspan="7" align="center">没有内容</td>
									</tr>
								</c:if>
								<c:if test="${list!=null}">
									<c:forEach var="network" items="${list}" varStatus="xh">
										<tr>
											<td><c:out value="${xh.count}" /></td>
											<td><c:out value="${network.nId}" /></td>
											<td><c:out value="${network.nName}" /></td>
											<td><c:out value="${network.nCode}" /></td>
											<td><c:out value="${network.nLeader}" /></td>
											<td><c:out value="${network.nLeaderTelphone}" /></td>
											<td><a href="delete.do?id=${network.nId}"><i
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">新增区域信息</h4>
				</div>
					...
					<form class="form-horizontal" id="addForm" method="post"
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" name="nName" class="form-control input-sm"
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" name="nCode" class="form-control input-sm"
										id="inputEmail3" check-type="required">
								</div>
								<div class="col-sm-2"></div>
							</div>
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-2 control-label">区域负责人</label>
								<div class="col-sm-8">
									<input type="text" name="nLeader" class="form-control input-sm"
										id="inputEmail3" check-type="required">
								</div>
								<div class="col-sm-2"></div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" name="nLeaderTelphone"

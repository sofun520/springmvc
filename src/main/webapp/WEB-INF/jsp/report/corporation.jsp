...
<body class="hold-transition skin-blue sidebar-mini"
				...
				<div class="box">
					...
					<div class="box-body row">
							...
							<div class="box box-primary">
								<div class="box-body no-padding">
									<ul class="nav nav-pills nav-stacked table">
										...
										<li><a href=''><i
												class="fa fa-file-text-o"></i>2016年7月各地区月装车统计单</a></li>
										<li class='active'><a href=''><i
												class="fa fa-file-text-o"></i>2016年6月各地区月装车统计单</a></li>
									</ul>
								</div>
								<!-- /.box-body -->
							</div>
						...
						<div class="col-md-9">
							<div class="box box-primary">
								<div class="box-header with-border">
									<div style="text-align: center"><h3 class="box-title">2016年6月月装车统计单</h3></div>
									...
									<div class="mailbox-read-message">
										...
										<div class="box-body">
											<div class="chart">
												...
												<p style="text-align: center">2016年6月各地区月装车统计图</p>
	...
	<script src="http://cdn.bootcss.com/Chart.js/2.1.6/Chart.js"></script>

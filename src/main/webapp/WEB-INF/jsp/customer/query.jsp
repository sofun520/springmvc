									...
									<table style="width: 100%">
										<tr>
											...
											<td width="18%"><input name="cName"
												value="<c:out value="${customer.cName}" />" class="form-control input-sm"></td>
											<td align="center" width="7%">身份证号:</td>
											<td width="18%"><input name="cIdentity"
												value="<c:out value="${customer.cIdentity}" />" class="form-control input-sm"></td>
											<td align="center" width="7%">电话号码:</td>
											<td width="18%"><input name="cTelephone"
												value="<c:out value="${customer.cTelephone}" />" class="form-control input-sm"></td>
...
table-striped table-hover dataTable">
							<tbody>
								...
								<c:if test="${list== null || fn:length(list) == 0}">
									<tr>
										<td colspan="8" align="center">没有内容</td>
									</tr>
								</c:if>
								<c:if test="${list!=null}">
									<c:forEach var="cus" items="${list}" varStatus="xh">
										<tr>
											<td><c:out value="${xh.count}" /></td>
											<td><c:out value="${cus.cId}" /></td>
											<td><c:out value="${cus.cName}" /></td>
											<td><c:out value="${cus.cIdentity}" /></td>
											<td><c:out value="${cus.cTelephone}" /></td>
											<td><c:out value="${cus.cAddress}" /></td>
											<td><fmt:formatDate value="${cus.cCreateTime}"
